...
<c:set var="Amount" value="98550.141154577576" />  
...
<fmt:bundle basename="advanced.java.program.Simple" prefix="lang.">  
   <fmt:message key="hindi"/><br/>  
   <fmt:message key="english"/><br/>  
  <fmt:message key="french"/><br/>  
</fmt:bundle>  
<br>
